...
predictor = YOLO('/home/robotlab/work2/VOOM/PythonScripts/weights/yolov8x-seg.pt')
list_to_save = []
count = 0
for rgb_file in filenames['rgb']:
    ...
    list_to_save.append(dict_per_im)
with open('support_files/' + data_name + '_detections_yolov8x_seg_with_ellipse.json', 'w') as outfile:
